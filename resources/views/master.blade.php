        ...
        <div class="container-nav">
            <div class="navbar">
                <div class="logo-toggle-container">
                    <a href="{{ route('home')}}">
                        <img src="{{ asset('img/sugar.png')}}" alt="">
                    </a>
    ...
    <div class="warna" style="background-color: #842A2A;">
        ...
        <div class="md:flex md:justify-between h-60">
          <div class="grid grid-rows-4 grid-flow-col gap-4 py-4" style="color: #FFF6DF;">
            ...
            <form class="max-w-lg mx-auto">
              <label for="email-address-icon" class="block mb-2 text-sm font-medium text-gray-900" style="color: #FFF6DF;">Your Email</label>
              <div class="relative">
                <div class="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
                  <svg class="w-4 h-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="#F6B0BB" viewBox="0 0 20 16">
                    <path d="m10.036 8.278 9.258-7.79A1.979 1.979 0 0 0 18 0H2A1.987 1.987 0 0 0 .641.541l9.395 7.737Z"/>
                    <path d="M11.241 9.817c-.36.275-.801.425-1.255.427-.428 0-.845-.138-1.187-.395L0 2.6V14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2.5l-8.759 7.317Z"/>
                  </svg>
                </div>
                <input type="text" id="email-address-icon" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-pink-500 focus:ring-pink-500 block w-full ps-10 p-2.5 " placeholder="name@flowbite.com">
              </div>
            </form>
          </div>

          <div class="grid grid-cols-2 gap-6 sm:gap-6 sm:grid-cols-3 pt-4">
            <div style="transform: translateX(150px);">
              ...
              <ul class="font-medium" style="color: #FFF6DF;">
                <li class="mb-4">
                  <a href="{{ route('profilepage')}}" class="hover:underline;" style="color: #FFF6DF;">Profile</a>
                </li>
                <li class="mb-4">
                  <a href="{{ route('collab')}}" class="hover:underline" style="color: #FFF6DF;">Collaboration</a>
                </li>
                <li>
                  <a href="#" class="hover:underline" style="color: #FFF6DF;">Our Team</a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="py-6" style="background-color: #FFF6DF">
        <div class="sm:flex sm:items-center sm:justify-between px-6">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" class="hover:underline text-gray-500">Sugar Plum™</a>. All Rights Reserved.</span>
